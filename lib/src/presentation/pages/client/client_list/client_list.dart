...
class ClientList extends StatefulWidget {
  const ClientList({super.key, required this.clientNotifier});
...
class _ClientListState extends State<ClientList> {
  ...
  void snackBar({required BuildContext context}) {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Time out of range'),
      ...
      children: [
                ...
                children: [
                  DropdownButton<String>(
                    ...
                    onChanged: (value) {
                      ...
                      int endTimeIndex = timeOptions.indexOf(selectedEndTime);
              ...
              Column(
                children: [
                  DropdownButton<String>(
                    ...
                    onChanged: (value) {
                      int startTimeIndex = timeOptions.indexOf(selectedTime);
                      int endTimeIndex =
        ...
        CustomSubmitButton(onTap: () {
          ...
          if (addedTimes.isNotEmpty) {
            widget.clientNotifier.changeStatus(status: ClientStatus.reserve);
          }
        }),
        const SizedBox(
          height: 21,
